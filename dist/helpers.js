...
export function isSubscribeFormFieldKey(value) {
    return SUBSCRIBE_FORM_FIELD_KEYS.includes(value);
}
/**
 ...
 */
export function normalizeBrandDomain(domain) {
    return domain
        .trim()
        .toLowerCase()
        .replace(/^https?:\/\//, '')
 ...
 */
export function domainToBrandSlug(domain) {
