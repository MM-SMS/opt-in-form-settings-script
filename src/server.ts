...
import type {
  CreateSubscribeFormConfigOptions,
  SubscribeFormBrand,
  SubscribeFormConfig,
  SubscribeFormConfigContext,
  SubscribeFormConfigResult,
} from './types'
...
export type {
  ...
  SubscribeFormFieldConfig,
  SubscribeFormFieldKey,
} from './types'
...
function readEnv(options?: CreateSubscribeFormConfigOptions['env']) {
  return {
...
function toContext(brand: SubscribeFormBrand): SubscribeFormConfigContext {
  return {
...
export function createSubscribeFormConfig(options: CreateSubscribeFormConfigOptions) {
  function defaultsFor(brand: SubscribeFormBrand): SubscribeFormConfig {
    return buildDefaultSubscribeFormConfig(brand, options.getDefaultTexts?.(brand))
  }

  async function loadResult(): Promise<SubscribeFormConfigResult> {
  ...
  async function getSubscribeFormConfigResultFresh(): Promise<SubscribeFormConfigResult> {
    return loadResult()
  }

  async function getSubscribeFormConfigFresh(): Promise<SubscribeFormConfig> {
    return (await loadResult()).config
  }

  async function getSubscribeFormConfig(): Promise<SubscribeFormConfig> {
    const brand = options.getBrand()
  ...
  function getDefaultSubscribeFormConfig(): SubscribeFormConfig {
